...
export function RoastOverlay({ item, roastMode }: RoastOverlayProps) {
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 pb-6 sm:pb-10 flex flex-col items-stretch">
      ...
      <div className="px-3 sm:px-6 flex items-end justify-between gap-3">
        <div className="max-w-md">
          <div className="inline-flex flex-col gap-1 rounded-3xl bg-gradient-to-tr from-black/80 via-slate-900/80 to-black/40 border border-white/10 px-4 py-3 shadow-roast-lg backdrop-blur-md animate-roast-pop">
